  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1 container py-10">
        ...
        <TypographyH2 className="mt-10">1. Information We Collect</TypographyH2>
        <TypographyP>
        ...
        <TypographyP>
          ...
          interact with our website, including the pages you visit, the features
        ...
        <TypographyP>
          2.2 Communication: We may use your contact information to communicate
          with you about your account and updates to our services. We may also
          send you promotional emails and other marketing communications, which
        ...
        <TypographyP>
          ...
          applicable laws, regulations, and legal processes, and to protect the
          rights, property, and safety of Tucon, our users, and others.
        </TypographyP>
        ...
        <TypographyP>
          ...
          service providers who help us operate our website, and provide other
          services.
        </TypographyP>
        <TypographyP>
        ...
        <TypographyP>
          ...
          to a subpoena, court order, or other legal request, or to comply with
          applicable laws and regulations.
        </TypographyP>
        <TypographyP>
          3.4 Business Transfers: If Tucon is involved in a merger, acquisition,
        ...
        <TypographyP>
          ...
          information at any time by accessing your account settings within the
          website.
        </TypographyP>
        <TypographyP>
        ...
        <TypographyP>
          ...
          material changes by posting the updated Privacy Policy within the
        ...
        <TypographyP>
          ...
          practices, please contact us at benjamin.sengupta@gmail.com. By using
          Tucon, you agree to the collection and use of your information as
