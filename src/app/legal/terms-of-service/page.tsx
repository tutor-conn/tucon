    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="flex-1 container py-10">
        ...
        <TypographyP>
          ...
          using Tucon, you represent and warrant that you are at least 18 years
          old.
        </TypographyP>
        <TypographyP>
          1.2 Account Registration: You may need to create an account to access
          certain features of Tucon. You are responsible for maintaining the
        ...
        <TypographyP>
          ...
          violates applicable laws or regulations, infringes upon the rights of
          others, or is harmful to Tucon or its users.
        </TypographyP>

        <TypographyH2 className="mt-10">2. Tutoring Services</TypographyH2>
        <TypographyP>
          2.1 Connecting with Tutors: Tucon provides a platform to connect users
          with tutors for educational purposes. We do not employ or endorse any
          tutors listed on Tucon, and we are not responsible for the quality or
          outcomes of tutoring sessions.
        </TypographyP>
        <TypographyP>
          2.2 Payments: Users may be required to pay fees for tutoring services.
          Payment processing is not provided by Tucon and must be organized
          between the tutor and the student.
        </TypographyP>
        <TypographyP>
          2.3 Feedback: Users may provide feedback and ratings for tutors based
          on their experiences. You agree to provide honest and accurate
        ...
        <TypographyH2 className="mt-10">4. Intellectual Property</TypographyH2>
        <TypographyP>
          All intellectual property rights in Tucon, including Tucon itself and
          its content, are owned by or licensed to us. You may not use,
        ...
        <TypographyP>
          ...
          <Anchor href="/legal/privacy-policy">Privacy Policy</Anchor>, which is
          incorporated into these Terms by reference. By using Tucon, you
        ...
        <TypographyP>
          ...
          of or in connection with your use of Tucon.
        </TypographyP>
        ...
        <TypographyP>
          ...
          of the Province of Ontario. Any disputes arising out of or in
